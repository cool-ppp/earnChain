...
export default function PoolsAmount() {
  return (
    <div className="grid grid-cols-3 gap-[24px]">
      <div className="col-span-2 border-solid border-neutralBorder border-[1px] rounded-[12px] overflow-hidden">
        <div className="text-lg bg-brandPressed h-[60px] leading-[60px] text-white pl-8 flex font-semibold">
          XPSGR Points Pools
        </div>
        <div className="grid grid-cols-2 p-8 bg-brandBg">
          <div>
      ...
      <div className="col-span-1 border-solid border-neutralBorder border-[1px] rounded-[12px] overflow-hidden">
        <div className="text-lg bg-brandPressed  h-[60px] leading-[60px] text-white pl-8 flex font-semibold">
          SGR Pool
        </div>
        <div className="p-8">
